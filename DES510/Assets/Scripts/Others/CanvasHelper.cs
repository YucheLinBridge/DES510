...
{
    public string SafeAreaName = "SafeArea";
    ...
    void ApplySafeArea()
    {
        ...
        if (safeArea.height==Screen.height &&safeArea.width==Screen.width)
        {
        ...
        {
            anchorMin = safeArea.position + new Vector2(Padding.Left, Padding.Bottom);
            anchorMax = safeArea.position + safeArea.size - new Vector2(Padding.Right, Padding.Top);
        }
